    ...
    const initWebGL = () => {
      ...
      try {
        renderer = new Renderer({
          ...
          alpha: true,
          antialias: false,
          dpr: 1   // cap at 1 — halves pixel count, big perf win for background shader
        });
        gl = renderer.gl;
      } catch (e) {
        console.warn('Grainient: WebGL context creation failed.', e);
        return;
      }
      ...
      const setSize = () => {
        if (!renderer || !gl || !program || !mesh) return;
