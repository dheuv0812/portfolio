    ...
    <div className="w-full min-h-screen bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:4rem_4rem] pt-24 sm:pt-32 pb-24 px-3 sm:px-6 md:px-20 lg:px-28 overflow-x-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 sm:mb-10 border-b border-black/5 pb-6">
          ...
          >
            PROFESSIONAL<br />
            <span className="text-[var(--c-accent-2)]">ENGAGEMENTS</span>
          </h1>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="border-[3px] border-black rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-[8px_8px_0px_0px_var(--c-shadow)] hover:shadow-[12px_12px_0px_0px_var(--c-accent-2)] hover:-translate-x-1 hover:-translate-y-1 transition-all duration-300 bg-white/70 backdrop-blur-md"
          >
            ...
            <div className="lg:hidden flex flex-col">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent p-4 flex flex-col justify-end text-white">
                  <span className="text-[8.5px] font-black uppercase text-[var(--c-accent)] tracking-widest">{item.industry}</span>
                ...
                <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-md text-[var(--c-accent)] border border-[var(--c-accent)]/30 text-[8px] font-black px-2.5 py-1 rounded-full uppercase">
                  👁️ Tap Image
                </div>
              </div>
              ...
              <div className="p-4 flex flex-col gap-4">
                {activeMobileTab === 'overview' && (
                  <div className="flex flex-col gap-3">
                    <div>
                      ...
                      <p className="text-black/80 text-xs font-semibold leading-relaxed bg-[var(--c-accent-2)]/5 p-3 rounded-xl border border-black/5">
                        {item.outcome}
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col gap-3 text-xs">
                    <div>
                      <h4 className="font-black text-black text-[11px] uppercase tracking-wider flex items-center gap-1 mb-1.5">
                        <FaBriefcase className="text-[var(--c-accent-2)]" /> Responsibilities
                      </h4>
                    ...
                    <div className="border-t border-black/5 pt-2">
                      <h4 className="font-black text-black text-[11px] uppercase tracking-wider flex items-center gap-1 mb-1.5">
                        <FaHandshake className="text-[var(--c-accent-2)]" /> Deliverables
                      </h4>
                      <ul className="flex flex-col gap-1 text-[11px] font-medium text-black/70">
                ...
                {activeMobileTab === 'lessons' && (
                  <div className="flex flex-col gap-3">
                    <div className="bg-[var(--c-panel-bg)] text-white rounded-xl p-4 border border-black flex gap-2.5 items-start">
                      <FaQuoteLeft className="w-3.5 h-3.5 text-[var(--c-accent)] flex-shrink-0 mt-1" />
                      <div>
                        <span className="text-[8px] font-black text-[var(--c-accent)] uppercase block mb-1">LESSONS LEARNED</span>
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-black/5">
                      <button
                        ...
                        className="flex-1 text-[9.5px] font-black uppercase bg-[var(--c-bg-surface)] border border-black py-2 rounded-xl text-black"
                      >
                        👁️ Preview Layout
                      </button>
                      {(item as any).cert && (
                         <button
                           ...
                           className="flex-1 text-[9.5px] font-black uppercase bg-[var(--c-accent)] border border-black py-2 rounded-xl text-black flex items-center justify-center gap-1"
                         >
                      ...
                      {item.links.map(l => (
                        l.url !== '#' ? (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex-1 text-[9.5px] font-black uppercase bg-[var(--c-bg-surface)] border border-black py-2 rounded-xl text-black text-center"
                          >
                            Live Site ↗
                          </a>
                        ) : null
            ...
            <div className="hidden lg:flex flex-row">
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 flex items-center justify-center pointer-events-none">
                  <span className="bg-[var(--c-accent)] text-black border-2 border-black font-black text-xs px-4 py-2 rounded-full uppercase tracking-wider shadow-md">
                    🔍 Click to Preview
                  </span>
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent p-8 flex flex-col justify-end text-white text-left">
                  <span className="text-[9px] font-black uppercase tracking-widest text-[var(--c-accent)] mb-1.5">
                    {item.industry}
                  </span>
                  <div className="flex items-center gap-2.5 mb-2.5">
                    {item.logo && (
                      <div className="w-8 h-8 rounded-lg bg-[var(--c-bg-surface)] p-1.5 flex items-center justify-center flex-shrink-0 shadow-md">
              ...
              <div className="flex-1 p-8 flex flex-col gap-6 justify-between">
                <div className="flex flex-col gap-4 text-left">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-black text-black text-xs uppercase tracking-wider flex items-center gap-1.5 mb-2">
                        <FaBriefcase className="text-[var(--c-accent-2)]" /> Core Responsibilities
                      </h4>
                  ...
                  <div className="bg-[var(--c-panel-bg)] text-white rounded-2xl p-5 border-2 border-black flex gap-3 items-start relative overflow-hidden shadow-md">
                    ...
                    <FaQuoteLeft className="w-4 h-4 text-[var(--c-accent)] flex-shrink-0 mt-1" />
                    <div className="relative z-10 text-left">
                      <span className="text-[8px] font-black text-[var(--c-accent)] tracking-widest uppercase block mb-1">
                        LESSONS LEARNED
                      </span>
                ...
                <div className="flex items-center justify-between gap-4 pt-4 border-t border-black/5">
                  ...
                  <div className="flex flex-wrap gap-2">
                     <button
                       ...
                       className="text-[9.5px] font-black uppercase tracking-wider bg-[var(--c-bg-surface)] border-2 border-black px-3.5 py-1.5 rounded-full text-black hover:bg-black hover:text-white transition-colors flex items-center gap-1 shadow-sm cursor-pointer"
                     >
                       👁️ Preview Layout
                     </button>
                     {(item as any).cert && (
                       <button
                         ...
                         className="text-[9.5px] font-black uppercase tracking-wider bg-[var(--c-accent)] border-2 border-black px-3.5 py-1.5 rounded-full text-black hover:bg-black hover:text-[var(--c-accent)] transition-colors flex items-center gap-1.5 shadow-sm cursor-pointer"
                       >
                     ...
                     {item.links.map(l => (
                       l.url !== '#' ? (
                         <a
                           ...
                           target="_blank"
                           rel="noreferrer"
                           className="text-[9.5px] font-black uppercase tracking-wider bg-[var(--c-bg-surface)] border-2 border-black px-3.5 py-1.5 rounded-full text-black hover:bg-black hover:text-white transition-colors flex items-center gap-1 shadow-sm"
                         >
                         ...
                         <span
                           key={l.label}
                           className="text-[9.5px] font-black uppercase tracking-wider bg-[var(--c-accent)]/30 border-2 border-black/20 px-3.5 py-1.5 rounded-full text-black/40 flex items-center gap-1 select-none cursor-not-allowed"
        ...
        >
          <div className="relative max-w-5xl max-h-[80vh] flex flex-col items-center z-[70]">
            <button
              ...
              className="absolute -top-10 sm:-top-12 right-0 text-white hover:text-[var(--c-accent)] font-black text-xs sm:text-sm uppercase tracking-wider flex items-center gap-1 bg-black/60 px-3 py-1 rounded-full border border-white/20 cursor-pointer shadow-lg"
            >
              Close ✕
            </button>
            <img
