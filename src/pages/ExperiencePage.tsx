...
export function ExperiencePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:4rem_4rem] pt-24 sm:pt-32 pb-24 px-3 sm:px-6 md:px-20 lg:px-28 relative overflow-hidden">
        ...
        <div className="lg:hidden">
          ...
          <AnimatePresence mode="wait">
            {activeExp && (
              ...
              >
                {/* Header */}
                <div className="p-5 border-b-2 border-black bg-[var(--c-accent-2)]/5 flex flex-col gap-2">
                  <span className="text-[8.5px] font-black uppercase text-[var(--c-accent-2)] tracking-widest">
                  ...
                  <div className="flex items-center justify-between text-xs font-extrabold text-black/60 pt-1">
                    {activeExp.companyUrl ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[var(--c-accent-2)] hover:underline flex items-center gap-1 font-black"
                      >
                        <span>{activeExp.company}</span>
                        <FaExternalLinkAlt className="w-2.5 h-2.5 text-[var(--c-accent-2)]" />
                      </a>
                    ) : (
                      <span>{activeExp.company || activeExp.role}</span>
                    )}
                    <span className="text-[var(--c-accent-2)]">{activeExp.duration || activeExp.timeline}</span>
                  </div>
                </div>
