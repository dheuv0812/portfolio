    ...
    <div className="w-full min-h-screen bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:4rem_4rem] pt-24 sm:pt-32 pb-24 px-3 sm:px-6 md:px-20 lg:px-28 overflow-x-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 sm:mb-10 border-b border-black/5 pb-6">
          ...
          >
            ENGINEERING<br />
            <span className="text-[var(--c-accent-2)]">PROJECTS</span>
          </h1>
              ...
              <div className="flex items-center gap-2">
                {project.github && (
                  <a
                    ...
                    className="flex-1 sm:flex-initial px-3.5 sm:px-4 py-2 border-2 border-black rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider bg-[var(--c-bg-surface)] hover:bg-black hover:text-white flex items-center justify-center gap-1.5 transition-colors"
                  >
                    <FaGithub /> Repo
                  </a>
                )}
                {project.liveDemo && (
                  <a
                    ...
                    className="flex-1 sm:flex-initial px-3.5 sm:px-4 py-2 border-2 border-black rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider bg-[var(--c-accent)] hover:bg-black text-black hover:text-white flex items-center justify-center gap-1.5 transition-colors shadow-sm"
                  >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 border-t border-black/10 pt-3 text-xs">
                    <div>
                      ...
                      <span className="text-[10px] font-black text-[var(--c-accent-2)]">{project.year}</span>
                    </div>
                    <div>
                      <span className="text-[8.5px] font-black text-black/40 block uppercase">Project Status</span>
                      <p className="font-extrabold text-[var(--c-accent-2)] text-[11px] uppercase">{project.status}</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex gap-3 items-start">
                    ...
                    <div>
                      ...
                      <div className="bg-[var(--c-bg-surface)] rounded-xl p-3 border border-black/5 mt-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-black/80 leading-relaxed bg-[var(--c-bg-surface)] p-3 rounded-xl border border-black/10">
              ...
              {activeMobileTab === 'hurdles' && (
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <div className="bg-[var(--c-bg-surface)] rounded-xl p-3 border border-black/5 mt-2 flex flex-col gap-2.5">
                      ...
                      <p className="text-black/75 text-xs font-medium leading-relaxed border-t border-black/5 pt-2">
                        <strong className="text-[var(--c-accent-2)] block mb-0.5 uppercase text-[9px]">The Solution:</strong> {project.lessonsLearned}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="hidden lg:grid p-8 grid-cols-3 gap-8">
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <span className="text-xs font-black text-[var(--c-accent-2)] tracking-wider block mt-1">{project.year}</span>
                </div>
              ...
              <div className="col-span-2 flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-black/60 text-[11px] font-semibold leading-relaxed mt-2 italic bg-[var(--c-accent-2)]/5 px-3 py-2 rounded-xl border border-black/5">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <div className="bg-[var(--c-bg-surface)] rounded-2xl p-4 border border-black/5 mt-3">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-black/70 text-xs font-medium leading-relaxed mt-2">
                      <strong className="text-[var(--c-accent-2)]">The Solution:</strong> {project.lessonsLearned}
                    </p>
                  </div>
                </div>
              </div>
